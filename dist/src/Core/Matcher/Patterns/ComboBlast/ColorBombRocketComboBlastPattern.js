...
exports.ColorBombRocketComboBlastPattern = void 0;
...
class ColorBombRocketComboBlastPattern extends Pattern_1.Pattern {
    constructor() {
        super(...arguments);
    ...
    tryCreateMatch(params) {
        ...
        if (!(0, GemsHelpers_1.isGemsOfOnlyKinds)(swapGems, [BoardTypes_1.GemCoreName.ColorBomb, BoardTypes_1.GemCoreName.Rocket], justUsedCells)) {
            return null;
        }
    ...
    clone() {
        return new ColorBombRocketComboBlastPattern();
    }
}
exports.ColorBombRocketComboBlastPattern = ColorBombRocketComboBlastPattern;
//# sourceMappingURL=ColorBombRocketComboBlastPattern.js.map